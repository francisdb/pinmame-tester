...
use crate::libpinmame::{
    ...
    PinmameIsPaused, PinmameIsRunning, PinmameLampState, PinmamePause, PinmameReset, PinmameRun,
    PinmameSetConfig, PinmameSetDmdMode, PinmameSetHandleKeyboard, PinmameSetHandleMechanics,
    PinmameSetSwitch, PinmameSetSwitches, PinmameSetUserData, PinmameSolenoidState, PinmameStop,
    PinmameSwitchState, PINMAME_DMD_MODE, PINMAME_DMD_MODE_PINMAME_DMD_MODE_BRIGHTNESS,
