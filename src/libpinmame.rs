...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameGame"][::std::mem::size_of::<PinmameGame>() - 48usize];
    ["Alignment of PinmameGame"][::std::mem::align_of::<PinmameGame>() - 8usize];
    ["Offset of field: PinmameGame::name"][::std::mem::offset_of!(PinmameGame, name) - 0usize];
    ["Offset of field: PinmameGame::clone_of"]
        [::std::mem::offset_of!(PinmameGame, clone_of) - 8usize];
    ["Offset of field: PinmameGame::description"]
        [::std::mem::offset_of!(PinmameGame, description) - 16usize];
    ["Offset of field: PinmameGame::year"][::std::mem::offset_of!(PinmameGame, year) - 24usize];
    ["Offset of field: PinmameGame::manufacturer"]
        [::std::mem::offset_of!(PinmameGame, manufacturer) - 32usize];
    ["Offset of field: PinmameGame::flags"][::std::mem::offset_of!(PinmameGame, flags) - 40usize];
    ["Offset of field: PinmameGame::found"][::std::mem::offset_of!(PinmameGame, found) - 44usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameDisplayLayout"][::std::mem::size_of::<PinmameDisplayLayout>() - 28usize];
    ["Alignment of PinmameDisplayLayout"][::std::mem::align_of::<PinmameDisplayLayout>() - 4usize];
    ["Offset of field: PinmameDisplayLayout::type_"]
        [::std::mem::offset_of!(PinmameDisplayLayout, type_) - 0usize];
    ["Offset of field: PinmameDisplayLayout::top"]
        [::std::mem::offset_of!(PinmameDisplayLayout, top) - 4usize];
    ["Offset of field: PinmameDisplayLayout::left"]
        [::std::mem::offset_of!(PinmameDisplayLayout, left) - 8usize];
    ["Offset of field: PinmameDisplayLayout::length"]
        [::std::mem::offset_of!(PinmameDisplayLayout, length) - 12usize];
    ["Offset of field: PinmameDisplayLayout::width"]
        [::std::mem::offset_of!(PinmameDisplayLayout, width) - 16usize];
    ["Offset of field: PinmameDisplayLayout::height"]
        [::std::mem::offset_of!(PinmameDisplayLayout, height) - 20usize];
    ["Offset of field: PinmameDisplayLayout::depth"]
        [::std::mem::offset_of!(PinmameDisplayLayout, depth) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameAudioInfo"][::std::mem::size_of::<PinmameAudioInfo>() - 32usize];
    ["Alignment of PinmameAudioInfo"][::std::mem::align_of::<PinmameAudioInfo>() - 8usize];
    ["Offset of field: PinmameAudioInfo::format"]
        [::std::mem::offset_of!(PinmameAudioInfo, format) - 0usize];
    ["Offset of field: PinmameAudioInfo::channels"]
        [::std::mem::offset_of!(PinmameAudioInfo, channels) - 4usize];
    ["Offset of field: PinmameAudioInfo::sampleRate"]
        [::std::mem::offset_of!(PinmameAudioInfo, sampleRate) - 8usize];
    ["Offset of field: PinmameAudioInfo::framesPerSecond"]
        [::std::mem::offset_of!(PinmameAudioInfo, framesPerSecond) - 16usize];
    ["Offset of field: PinmameAudioInfo::samplesPerFrame"]
        [::std::mem::offset_of!(PinmameAudioInfo, samplesPerFrame) - 24usize];
    ["Offset of field: PinmameAudioInfo::bufferSize"]
        [::std::mem::offset_of!(PinmameAudioInfo, bufferSize) - 28usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameSwitchState"][::std::mem::size_of::<PinmameSwitchState>() - 8usize];
    ["Alignment of PinmameSwitchState"][::std::mem::align_of::<PinmameSwitchState>() - 4usize];
    ["Offset of field: PinmameSwitchState::swNo"]
        [::std::mem::offset_of!(PinmameSwitchState, swNo) - 0usize];
    ["Offset of field: PinmameSwitchState::state"]
        [::std::mem::offset_of!(PinmameSwitchState, state) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameSolenoidState"][::std::mem::size_of::<PinmameSolenoidState>() - 8usize];
    ["Alignment of PinmameSolenoidState"][::std::mem::align_of::<PinmameSolenoidState>() - 4usize];
    ["Offset of field: PinmameSolenoidState::solNo"]
        [::std::mem::offset_of!(PinmameSolenoidState, solNo) - 0usize];
    ["Offset of field: PinmameSolenoidState::state"]
        [::std::mem::offset_of!(PinmameSolenoidState, state) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameLampState"][::std::mem::size_of::<PinmameLampState>() - 8usize];
    ["Alignment of PinmameLampState"][::std::mem::align_of::<PinmameLampState>() - 4usize];
    ["Offset of field: PinmameLampState::lampNo"]
        [::std::mem::offset_of!(PinmameLampState, lampNo) - 0usize];
    ["Offset of field: PinmameLampState::state"]
        [::std::mem::offset_of!(PinmameLampState, state) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameGIState"][::std::mem::size_of::<PinmameGIState>() - 8usize];
    ["Alignment of PinmameGIState"][::std::mem::align_of::<PinmameGIState>() - 4usize];
    ["Offset of field: PinmameGIState::giNo"]
        [::std::mem::offset_of!(PinmameGIState, giNo) - 0usize];
    ["Offset of field: PinmameGIState::state"]
        [::std::mem::offset_of!(PinmameGIState, state) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameLEDState"][::std::mem::size_of::<PinmameLEDState>() - 12usize];
    ["Alignment of PinmameLEDState"][::std::mem::align_of::<PinmameLEDState>() - 4usize];
    ["Offset of field: PinmameLEDState::ledNo"]
        [::std::mem::offset_of!(PinmameLEDState, ledNo) - 0usize];
    ["Offset of field: PinmameLEDState::chgSeg"]
        [::std::mem::offset_of!(PinmameLEDState, chgSeg) - 4usize];
    ["Offset of field: PinmameLEDState::state"]
        [::std::mem::offset_of!(PinmameLEDState, state) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameMechSwitchConfig"][::std::mem::size_of::<PinmameMechSwitchConfig>() - 16usize];
    ["Alignment of PinmameMechSwitchConfig"]
        [::std::mem::align_of::<PinmameMechSwitchConfig>() - 4usize];
    ["Offset of field: PinmameMechSwitchConfig::swNo"]
        [::std::mem::offset_of!(PinmameMechSwitchConfig, swNo) - 0usize];
    ["Offset of field: PinmameMechSwitchConfig::startPos"]
        [::std::mem::offset_of!(PinmameMechSwitchConfig, startPos) - 4usize];
    ["Offset of field: PinmameMechSwitchConfig::endPos"]
        [::std::mem::offset_of!(PinmameMechSwitchConfig, endPos) - 8usize];
    ["Offset of field: PinmameMechSwitchConfig::pulse"]
        [::std::mem::offset_of!(PinmameMechSwitchConfig, pulse) - 12usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameMechConfig"][::std::mem::size_of::<PinmameMechConfig>() - 352usize];
    ["Alignment of PinmameMechConfig"][::std::mem::align_of::<PinmameMechConfig>() - 4usize];
    ["Offset of field: PinmameMechConfig::type_"]
        [::std::mem::offset_of!(PinmameMechConfig, type_) - 0usize];
    ["Offset of field: PinmameMechConfig::sol1"]
        [::std::mem::offset_of!(PinmameMechConfig, sol1) - 4usize];
    ["Offset of field: PinmameMechConfig::sol2"]
        [::std::mem::offset_of!(PinmameMechConfig, sol2) - 8usize];
    ["Offset of field: PinmameMechConfig::length"]
        [::std::mem::offset_of!(PinmameMechConfig, length) - 12usize];
    ["Offset of field: PinmameMechConfig::steps"]
        [::std::mem::offset_of!(PinmameMechConfig, steps) - 16usize];
    ["Offset of field: PinmameMechConfig::initialPos"]
        [::std::mem::offset_of!(PinmameMechConfig, initialPos) - 20usize];
    ["Offset of field: PinmameMechConfig::acc"]
        [::std::mem::offset_of!(PinmameMechConfig, acc) - 24usize];
    ["Offset of field: PinmameMechConfig::ret"]
        [::std::mem::offset_of!(PinmameMechConfig, ret) - 28usize];
    ["Offset of field: PinmameMechConfig::sw"]
        [::std::mem::offset_of!(PinmameMechConfig, sw) - 32usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameMechInfo"][::std::mem::size_of::<PinmameMechInfo>() - 20usize];
    ["Alignment of PinmameMechInfo"][::std::mem::align_of::<PinmameMechInfo>() - 4usize];
    ["Offset of field: PinmameMechInfo::type_"]
        [::std::mem::offset_of!(PinmameMechInfo, type_) - 0usize];
    ["Offset of field: PinmameMechInfo::length"]
        [::std::mem::offset_of!(PinmameMechInfo, length) - 4usize];
    ["Offset of field: PinmameMechInfo::steps"]
        [::std::mem::offset_of!(PinmameMechInfo, steps) - 8usize];
    ["Offset of field: PinmameMechInfo::pos"]
        [::std::mem::offset_of!(PinmameMechInfo, pos) - 12usize];
    ["Offset of field: PinmameMechInfo::speed"]
        [::std::mem::offset_of!(PinmameMechInfo, speed) - 16usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameSoundCommand"][::std::mem::size_of::<PinmameSoundCommand>() - 4usize];
    ["Alignment of PinmameSoundCommand"][::std::mem::align_of::<PinmameSoundCommand>() - 4usize];
    ["Offset of field: PinmameSoundCommand::sndNo"]
        [::std::mem::offset_of!(PinmameSoundCommand, sndNo) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameNVRAMState"][::std::mem::size_of::<PinmameNVRAMState>() - 8usize];
    ["Alignment of PinmameNVRAMState"][::std::mem::align_of::<PinmameNVRAMState>() - 4usize];
    ["Offset of field: PinmameNVRAMState::nvramNo"]
        [::std::mem::offset_of!(PinmameNVRAMState, nvramNo) - 0usize];
    ["Offset of field: PinmameNVRAMState::oldStat"]
        [::std::mem::offset_of!(PinmameNVRAMState, oldStat) - 4usize];
    ["Offset of field: PinmameNVRAMState::currStat"]
        [::std::mem::offset_of!(PinmameNVRAMState, currStat) - 5usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameKeyboardInfo"][::std::mem::size_of::<PinmameKeyboardInfo>() - 16usize];
    ["Alignment of PinmameKeyboardInfo"][::std::mem::align_of::<PinmameKeyboardInfo>() - 8usize];
    ["Offset of field: PinmameKeyboardInfo::name"]
        [::std::mem::offset_of!(PinmameKeyboardInfo, name) - 0usize];
    ["Offset of field: PinmameKeyboardInfo::code"]
        [::std::mem::offset_of!(PinmameKeyboardInfo, code) - 8usize];
    ["Offset of field: PinmameKeyboardInfo::standardcode"]
        [::std::mem::offset_of!(PinmameKeyboardInfo, standardcode) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of PinmameConfig"][::std::mem::size_of::<PinmameConfig>() - 616usize];
    ["Alignment of PinmameConfig"][::std::mem::align_of::<PinmameConfig>() - 8usize];
    ["Offset of field: PinmameConfig::audioFormat"]
        [::std::mem::offset_of!(PinmameConfig, audioFormat) - 0usize];
    ["Offset of field: PinmameConfig::sampleRate"]
        [::std::mem::offset_of!(PinmameConfig, sampleRate) - 4usize];
    ["Offset of field: PinmameConfig::vpmPath"]
        [::std::mem::offset_of!(PinmameConfig, vpmPath) - 8usize];
    ["Offset of field: PinmameConfig::cb_OnStateUpdated"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnStateUpdated) - 520usize];
    ["Offset of field: PinmameConfig::cb_OnDisplayAvailable"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnDisplayAvailable) - 528usize];
    ["Offset of field: PinmameConfig::cb_OnDisplayUpdated"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnDisplayUpdated) - 536usize];
    ["Offset of field: PinmameConfig::cb_OnAudioAvailable"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnAudioAvailable) - 544usize];
    ["Offset of field: PinmameConfig::cb_OnAudioUpdated"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnAudioUpdated) - 552usize];
    ["Offset of field: PinmameConfig::cb_OnMechAvailable"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnMechAvailable) - 560usize];
    ["Offset of field: PinmameConfig::cb_OnMechUpdated"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnMechUpdated) - 568usize];
    ["Offset of field: PinmameConfig::cb_OnSolenoidUpdated"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnSolenoidUpdated) - 576usize];
    ["Offset of field: PinmameConfig::cb_OnConsoleDataUpdated"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnConsoleDataUpdated) - 584usize];
    ["Offset of field: PinmameConfig::fn_IsKeyPressed"]
        [::std::mem::offset_of!(PinmameConfig, fn_IsKeyPressed) - 592usize];
    ["Offset of field: PinmameConfig::cb_OnLogMessage"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnLogMessage) - 600usize];
    ["Offset of field: PinmameConfig::cb_OnSoundCommand"]
        [::std::mem::offset_of!(PinmameConfig, cb_OnSoundCommand) - 608usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn PinmameSetTimeFence(timeInS: f64);
}
unsafe extern "C" {
